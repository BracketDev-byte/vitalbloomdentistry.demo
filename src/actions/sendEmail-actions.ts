...
export async function sendAppointmentEmail(
  ...
  try {
    const fromAddress = process.env.RESEND_FROM || 'Vital Bloom <onboarding@resend.dev>';
    const adminRecipient = process.env.BOOKINGS_INBOX || 'bracketdev.official@gmail.com';
    const subject = urgencyLevel === 'emergency' 
